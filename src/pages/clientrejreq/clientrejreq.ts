...
/**
 * Generated class for the ClientrejreqPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-clientrejreq',
  templateUrl: 'clientrejreq.html',
})
export class ClientrejreqPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ClientrejreqPage');
  }
  ...
  getappreqdata() {
    ...
    let prm = { fn: 'clirejrej', uid: this.sha.getuserid() }
