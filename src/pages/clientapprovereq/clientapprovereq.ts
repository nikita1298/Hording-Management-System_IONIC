...
/**
 * Generated class for the ClientapprovereqPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-clientapprovereq',
  templateUrl: 'clientapprovereq.html',
})
export class ClientapprovereqPage {
  ...
  getappreqdata(){
    ...
    let prm={fn:'clienapprove',uid:this.sha.getuserid()}
