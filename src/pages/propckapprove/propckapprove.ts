...
/**
 * Generated class for the PropckapprovePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-propckapprove',
  templateUrl: 'propckapprove.html',
})
export class PropckapprovePage {
  obj:any;
  o2:any;
  da:any;
  s:any;
  ...
  getappreqdata(){
    ...
    let prm={fn:'proapprovepck',uid:this.sha.getuserid()}
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PropckapprovePage');
  }
