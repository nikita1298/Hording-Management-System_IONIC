...
/**
 * Generated class for the ProviderapprovereqPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-providerapprovereq',
  templateUrl: 'providerapprovereq.html',
})
export class ProviderapprovereqPage {
obj:any;
o2:any;
da:any;
s:any;
...
getappreqdata(){
  ...
  let prm={fn:'approvereq',uid:this.sha.getuserid()}
...
console.log(this.o2);
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ProviderapprovereqPage');
  }
