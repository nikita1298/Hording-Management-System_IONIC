...
/**
 * Generated class for the PropckrejPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-propckrej',
  templateUrl: 'propckrej.html',
})
export class PropckrejPage {
  ...
  getappreqdata(){
    ...
    let prm={fn:'prorejpck',uid:this.sha.getuserid()}
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PropckrejPage');
  }
