...
import { PropckstatePage } from '../propckstate/propckstate';

/**
 * Generated class for the PackstatedataPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-packstatedata',
  templateUrl: 'packstatedata.html',
})
export class PackstatedataPage {
...
this.sh=false;
  ...
  close(){
    this.navCtrl.setRoot(PropckstatePage);
  }
...
this.nr=this.da[this.s].nr;
this.nry=this.da[this.s].nry;
this.nrn=this.da[this.s].nrn;
